...
function ContactUs() {
  ...
  const [sendMassage, { isLoading }] = useCreateContactMutation();

  const onSubmit: SubmitHandler<FormInputs> = async (data) => {
    try {
      await sendMassage(data).unwrap();
      ...
      <div className="max-w-screen-xl mx-auto px-4  lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-8 gap-y-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <label
                          htmlFor="name"
                          className="block text-base font-medium text-font-1 mb-2"
                        >
                          Your Name
                        </label>
                        <input
          ...
          <aside className="order-1 lg:order-2 lg:col-span-1 mt-12 lg:mt-0 flex flex-col gap-4">
            <h1 className="text-[32px] font-medium text-success font-akshar">
              Important Links
            </h1>
