...
const AboutSection = () => {
  ...
  const notices = [
    ...
    { title: "Ut enim ad minim veniam, quis nostrud exercitation", date: "25 Nov, 2024" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-12">
          ...
          <aside className="lg:col-span-1 mt-12 lg:mt-0">
            <div className=" text-white bg-success px-1 pb-1 rounded ">
              <h3 className="text-2xl font-medium font-akshar py-3 bg-success pl-6">Notice Board</h3>
